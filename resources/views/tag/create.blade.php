            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Gọi đến store của TagController --}}
                        <form action="/tag" method="post">
                            ...
                            <input class="btn btn-primary mt-4" type="submit" value="Add Tag">
                        </form>

                        <a class="btn btn-primary float-right" href="/tag"><i class="fas fa-arrow-circle-up"></i> Back to Tag</a>

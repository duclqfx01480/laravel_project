...
{{--                            <img class="img-thumbnail" src="/img/300x400.jpg" alt="{{ auth()->user()->name }}">--}}
                            <img class="img-thumbnail" src="{{ URL::asset('img/300x400.jpg') }}" alt="{{ auth()->user()->name }}">
                        </div>
                    </div>
...
{{--                                    <img src="/img/thumb_landscape.jpg" alt="thumb">--}}
                                    <img src="{{ URL::asset('img/thumb_landscape.jpg') }}" alt="thumb"></a>
                                    {{ $hobby->name }}
                                </a>
                                ...
                                @auth
                                    <a class="btn btn-sm btn-outline-primary mr-2 float-right" href="/hobby/{{ $hobby->id }}/edit"><i class="fas fa-edit"></i> Edit</a>
                                @endauth
